    ...
    return Scaffold(
        ...
        GridView.count(
            ...
            children: List.generate(16, (index) {
              imageName = (index < 9
                  ? 'assets/pic/image0${(index + 1)}.jpg'
                  : 'assets/pic/image${(index + 1)}.jpg');
              printText = (index == 0
                  ? "Ajanta Cave"
                  : index == 1
                      ? "Fatehpur Sikri"
                  ...
                  if (index == 0) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            ...
                            "assets/pic/image01.jpg",
                            "assets/image/image21.jpg")));
                  } else if (index == 1) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Fatehpur Sikri",
                            ...
                            "assets/pic/image02.jpg",
                            "assets/image/image22.jpg")));
                  } else if (index == 2) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Hawa Mahal",
                            ...
                            "assets/pic/image03.jpg",
                            "assets/image/image23.jpg")));
                  } else if (index == 3) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Imambara",
                            ...
                            "assets/pic/image04.jpg",
                            "assets/image/image24.jpg")));
                  } else if (index == 4) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "India Gate",
                            ...
                            "assets/pic/image05.jpg",
                            "assets/image/image25.jpg")));
                  } else if (index == 5) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Indian Museum",
                            ...
                            "assets/pic/image06.jpg",
                            "assets/image/image26.jpg")));
                  } else if (index == 6) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Jallianwala Bagh",
                            ...
                            "assets/pic/image07.jpg",
                            "assets/image/image27.jpg")));
                  } else if (index == 7) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Konark",
                            ...
                            "assets/pic/image08.jpg",
                            "assets/image/image28.jpg")));
                  } else if (index == 8) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Mysore Palace",
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            ...
                            "assets/pic/image10.jpg",
                            "assets/image/image30.jpg")));
                  } else if (index == 10) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "National Library",
                            ...
                            "assets/pic/image11.jpg",
                            "assets/image/image31.jpg")));
                  } else if (index == 11) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "National Museum",
                            ...
                            "assets/pic/image12.jpg",
                            "assets/image/image32.jpg")));
                  } else if (index == 12) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Qutub Minar",
                            ...
                            "assets/pic/image13.jpg",
                            "assets/image/image33.jpg")));
                  } else if (index == 13) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Red Fort",
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            ...
                            "assets/pic/image15.jpg",
                            "assets/pic/image35.jpg")));
                  } else if (index == 15) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => Model(
                            "Victoria Museum",
                            ...
                            "assets/pic/image16.jpg",
                            "assets/pic/image36.jpg")));
                  }
                },
              );
            })));
